...
# The Early Roblox Project

While the Discord community was growing, RGIS also had its own places on Roblox.
...
During the summer of 2024, especially around **August**, the situation became much more serious.
...
The raid included mass messages, spam and bans.

A large number of people were affected, and many members left the community. Around half of the members were banned during the events surrounding the conflict.

Afterwards, Danya blocked many of the remaining members and eventually deleted the Discord server.
...
I eventually joined IIRC as well.
...
Eventually, I was unable to reach him.

This incident remained one of the more serious moments connected to the IIRC period.
...
It later became known as **IRC**.

This was a different server from both the original RGIS and IIRC.

I worked on IRC together with **Fereque**.
...
After IRC, I decided to create a **new RGIS Discord server together with Danya**.

This became the **current RGIS**.

It is important to make the distinction clear:
...
The project also introduced systems that did not exist in the original RGIS.

One of the biggest examples is the **Commends system**, which became part of RGIS's progression and ranking system.

The modern RGIS also includes or plans different gameplay and training modes, such as:
...
The Training Centre became one of the main parts of the entire RGIS project.
...
The blue acid is not just decoration. It is part of the lore and technology of the RGIS universe.

In the RGIS world, the blue acid is a powerful resource that can be used to create **energy**.

It can also be processed and used in the production of **weapons and other equipment**.

However, the substance is extremely dangerous in its natural state.

It is still an acid, meaning that direct exposure can be lethal.
...
The leadership of RGIS has changed significantly since the original server.

MrFantastik eventually became inactive and stopped contributing much to the community.
...
- A working Training Centre
- Training sessions
- A ranking system
- Commends
- PvP and other gameplay modes
- Events and tournaments
- Community photos and traditions
- Returning members from the original RGIS
...
RGIS started with roughly ten friends who simply wanted to play Innovation Inc. together.
